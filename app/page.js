...
export default function Home() {
  ...
  const botsData = {
    '1º Año':[2.7053185619112816,-2.8632620943137748,2.660733061555775,2.7714041498505653,-2.8042228188425575,2.6697997600435595,2.6637095664768022,-2.788095969260139,2.6939567949358105,2.7363753903537646],
    '2º Año': [-2.8693975097029925,2.874962955414567,-3.101096273441973,2.806188301078461,2.806031669751097,-2.7452402585376654,-2.7724309871723833,2.661318212633306,-3.173406888917731,2.891439536423486,2.736327124266775,2.925933105116205,-2.8671240217885643,-2.9518586613190343,2.785133626998985,2.675846778313762,2.674634699109271,2.688699915273272],
    '3º Año': [2.6821654645632567,-3.5109008471729433,3.0678262270647383,3.0023541406813106,-2.8374381860428017,2.729660184488925,-2.792963101504058,-3.0333620579257476,2.7038446080413223,-3.005630702002627,2.8473787745550685,2.677564736665481],
    '4º Año': [-2.979626535520318,2.703558256494455,2.6978106430525615,-2.7491567667737318,2.852583740322108,-2.770156350025622,2.6963579611671973,-2.83682711264004,-3.006900185882845,2.915722132147557,-2.7430666430196338,2.947215112154261,2.6788782250450223,2.7461062174250372],
    '5º Año': [2.750801204026204,-2.786238404848457,2.6998796096265245,-2.77062880034549,3.136202608809934,2.7264683034356643,2.752960985913371,2.7467472159092634,-2.799143226128845,2.671176882092522,2.727559326006214,2.7986687397990377,-2.75324792809923,2.8295116256561053]
  };
...
const calculateReturns = (trades, leverageMultiplier = 1, initialCapital = 100) => {
  ...
  const results = useMemo(() => ({
    '1º Año': calculateReturns(botsData['Backtester1Y'], leverage),
    '2º Año': calculateReturns(botsData['Backtester2Y'], leverage),
    '3º Año': calculateReturns(botsData['Backtester3Y'], leverage),
    '4º Año': calculateReturns(botsData['Backtester4Y'], leverage),
    '5º Año': calculateReturns(botsData['Backtester5Y'], leverage)
  }), [leverage]);
