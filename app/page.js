...
const calculateReturns = (trades, leverageMultiplier = 1, initialCapital = 100) => {
  ...
  const results = useMemo(() => ({
    ...
    'Backtester2Y': calculateReturns(botsData['Backtester2Y'], leverage),
    'Backtester3Y': calculateReturns(botsData['Backtester3Y'], leverage),
    'Backtester4Y': calculateReturns(botsData['Backtester4Y'], leverage),
    'Backtester5Y': calculateReturns(botsData['Backtester5Y'], leverage)
  }), [leverage]);
